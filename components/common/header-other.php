	<?php include_once( ABSPATH . 'wp-admin/includes/plugin.php' ); ?>
		<header class="l-header p-webdesign">
				...
				<?php global $wp_query;
					if( $wp_query -> have_posts( $args ) ) :
						while( $wp_query -> have_posts() ) :
							...
							<?php if ( $url ) : ?>
								<a href="<?php echo $url ?>" target="_blank" class="p-taxonomy-webdesign__url"><?php echo $url ?></a>
							<?php endif; ?>
							<?php if ( $tags ) : ?>
								<p class="p-taxonomy-webdesign__tag"><?php echo esc_html( $type_tags ); ?></p>
							<?php endif; ?>
							<?php if ( $date ) : ?>
								<p class="p-taxonomy-webdesign__date"><?php echo esc_html( $date ); ?></p>
							<?php endif; ?>
						<?php endwhile; ?>
					<?php endif;
				?>
